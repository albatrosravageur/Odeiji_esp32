...
#define FIREBASE_HOST "esp32led-b55bd.firebaseio.com"            // the project name address from firebase id
#define FIREBASE_AUTH "IyQ9dBnruwTbHYuh1nMscGfu8TN5Posd9SNz0TIM" // the secret key generated from firebase
#define WIFI_SSID "oue-oue"                                      // input your home or public wifi name
#define WIFI_PASSWORD "cbonnard"
